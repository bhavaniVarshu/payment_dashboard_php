...
if (isset($_GET['delete_user'])) {
  ...
  // Delete from task_info table
  $task_sql = "DELETE FROM task_info WHERE t_user_id = :id";
  $obj_admin->delete_data_by_this_method($task_sql, $action_id, $sent_po);

  // Delete from attendance_info table
  $attendance_sql = "DELETE FROM attendance_info WHERE atn_user_id = :id";
  $obj_admin->delete_data_by_this_method($attendance_sql, $action_id, $sent_po);

  // Delete from tbl_admin table
  $admin_sql = "DELETE FROM tbl_admin WHERE user_id = :id";
  $obj_admin->delete_data_by_this_method($admin_sql, $action_id, $sent_po);
}
